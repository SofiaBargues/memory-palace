          ...
          footer={
            <div className="mx-auto mt-5 grid w-full max-w-2xl gap-3 sm:grid-cols-2">
              <a href="/palace?start=chooseWords" className="block">
                <Button
                  size="lg"
                  className="h-12 w-full justify-between rounded-[5px] bg-black px-7 text-base font-semibold text-white shadow-[0_4px_4px_rgba(0,0,0,0.1)] transition-transform hover:-translate-y-0.5 hover:bg-[#262626]"
                >
                  Create a Palace
